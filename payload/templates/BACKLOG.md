...
<!--
- one item per line, plain prose, no heading needed beyond the section:
  - a public API for reading progress without opening the terminal
  - CSV export of the hours ledger
-->
