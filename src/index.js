...
//   process.exitCode = gates.exitCode;   // 0 clean, 1..6 = the failing gate
...
export { parsePrd, allAcs, SPEC_STATUSES } from './parsers/prd.js';
export { parseRfc, ASM_STATUSES, Q_STATUSES } from './parsers/rfc.js';
export { parseTdd, TASK_STATUSES } from './parsers/tdd.js';
